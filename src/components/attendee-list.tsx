        ...
        <table className="w-fulll ">
          <thead>
            <tr className="border-b border-white/10">
              <th className="py-3 px-4 text-ms font-semibold text-left">
                <input type="checkbox" />
              </th>
              <th className="py-3 px-4 text-ms font-semibold text-left">
                Código
              ...
              <th className="py-3 px-4 text-ms font-semibold text-left"></th>
            </tr>
          </thead>
          ...
          <tfoot>
            <tr>
              <td className="py-3 px-4 text-ms text-zinc-300" colSpan={3}>
